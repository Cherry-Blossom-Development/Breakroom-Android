...
class GalleryRepository(
    ...
    suspend fun createSettings(galleryUrl: String, galleryName: String, isPublic: Boolean = false, bio: String? = null): BreakroomResult<GallerySettings> {
        val authHeader = getAuthHeader() ?: return BreakroomResult.Error("Not logged in")
        return try {
            val request = GallerySettingsRequest(gallery_url = galleryUrl, gallery_name = galleryName, is_public = isPublic, bio = bio)
    ...
    suspend fun updateSettings(galleryUrl: String, galleryName: String, isPublic: Boolean = false, bio: String? = null): BreakroomResult<GallerySettings> {
        val authHeader = getAuthHeader() ?: return BreakroomResult.Error("Not logged in")
        return try {
            val request = GallerySettingsRequest(gallery_url = galleryUrl, gallery_name = galleryName, is_public = isPublic, bio = bio)
